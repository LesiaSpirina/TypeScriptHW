...
// checkInDate = tomorrow.toLocaleDateString()
      ...
      <fieldset class="search-filedset">
        ...
        <div class="row">
          <div>
            ...
            min="2023-04-21" max="2023-05-31" name="checkin" />
          </div>
          <div>
            <label for="check-out-date">Дата выезда</label>
            <input id="check-out-date" type="date"  value="${checkOutDate}" min="2023-04-23" max="2023-05-31" name="checkout" />
          </div>
          <div>
